...
export default function Asidebar() {
  ...
  return (
    <div className='h-[100%] fixed right-0 z-10 '>
      ...
      <Link onClick={toggleMenu} to={'/'} className="mb-4 bg-gray-700 hover:bg-yellow-500 p-2 rounded-full w-[50px] h-[50px] 
        ...
        <Link onClick={toggleMenu} to={'/about'} className="mb-4 bg-gray-700 hover:bg-yellow-500 p-2 rounded-full w-[50px] h-[50px] 
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative">
        ...
        <Link onClick={toggleMenu} to={'/contact'} className="mb-4 bg-gray-700 hover:bg-yellow-500 p-2 rounded-full w-[50px] h-[50px] 
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative">
        ...
        <Link onClick={toggleMenu} to={'/blog'} className="mb-4 bg-gray-700 hover:bg-yellow-500 p-2 rounded-full w-[50px] h-[50px] 
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative">
