...
export default function Asidebar() {
  ...
  return (
    <div className='h-screen'>
      ...
      <aside className={`fixed top-0 left-0 w-40 max-md:w-60 h-screen bg-gray-950 text-white flex flex-col justify-center items-center transition-transform duration-300 md:static ${
