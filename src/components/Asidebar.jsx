...
export default function Asidebar() {
  ...
  return (
    <div className="h-[100%] fixed right-0 z-10 ">
      ...
      >
        {isMenuOpen ? (
          <img loading="lazy" src={close} className="w-5" alt="" />
        ) : (
          <img loading="lazy" src={menu} className="w-5" />
        )}
      </button>
      ...
      >
        ...
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative"
          >
            ...
            <div className="bg-gray-700  absolute p-4 rounded-full right-0">
              <img loading="lazy" src={home} alt="" className="w-4 " />
            </div>
          </Link>
          <Link
            onClick={toggleMenu}
        ...
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative"
          >
            ...
            <div className="bg-gray-700 absolute p-4 rounded-full right-0">
              <img loading="lazy" src={about} alt="" className="w-4 " />
            </div>
          </Link>
          <Link
            onClick={toggleMenu}
        ...
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative"
          >
            ...
            <div className="bg-gray-700 absolute p-4 rounded-full right-0">
              <img loading="lazy" src={portfolio} alt="" className="w-4 " />
            </div>
          </Link>
          <Link
            onClick={toggleMenu}
        ...
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative"
          >
            ...
            <div className="bg-gray-700 absolute p-4 rounded-full right-0">
              <img loading="lazy" src={contact} alt="" className="w-4 " />
            </div>
          </Link>
          <Link
            onClick={toggleMenu}
        ...
        hover:w-[100%] max-md:w-[100%] transition-all duration-300 right-0 flex justify-center pr-10 items-center group relative"
          >
            ...
            <div className="bg-gray-700 absolute p-4 rounded-full right-0">
              <img loading="lazy" src={blog} alt="" className="w-4 " />
            </div>
          </Link>
        </ul>
      </aside>
