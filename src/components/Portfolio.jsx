...
export default function Portfolio() {
  return (
    <section className="w-full flex flex-col justify-center items-center h-full bg-gray-950 min-h-screen text-white py-10">
      <div className="w-[90%] flex flex-col items-center">
        ...
        <div className="w-full flex flex-wrap justify-center gap-6">
          {[...Array(6)].map((_, index) => (
            <div key={index} className="w-80 h-44 relative overflow-hidden group">
              <img
                src={website1}
                alt={`Project ${index + 1}`}
